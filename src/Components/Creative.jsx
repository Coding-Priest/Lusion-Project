  ...
  return (
    <div style = {{transform: 'rotateY(-180deg)'}} className="strategy-card">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 420" width="300" height="420">
        ...
        {/* Title */}
        <text x="20" y="35" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold">CREATIVE</text>
        
        {/* List items with dotted lines */}
        {['Art Direction', 'UX/UI Design', 'Motion Design', 'Game Design', 'Illustration'].map((item, index) => (
        ...
        {/* Bottom text (rotated) */}
        <text x="280" y="405" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" transform="rotate(180 140 202.5)">CREATIVE</text>
        
        {/* Pixelated "S" symbols */}
        {[{ x: 260, y: 20 }, { x: 20, y: 380 }].map((pos, index) => (
          <g key={index} transform={`translate(${pos.x},${pos.y}) scale(0.8)`}>
            {[
              [5,0], [10,0], [0,5], [0,10], [0,15], [5,20], [10,20]
            ].map(([x, y], i) => (
